            ...
            <div class="container">
                <div class="row">
                    <div class="col-3">
                        <p>Все категории</p>
                        <a href="#">
                            <p>Кабели и провода</p>
                        </a>
                        <a href="#">
                            <p>Трансформаторы</p>
                        </a>
                        <a href="#">
                            <p>Оборудование 6-10кВ</p>
                        </a>
                        <a href="#">
                            <p>Климатическое оборудование</p>
                        </a>
                        <a href="#">
                            <p>Изделия для электромонтажа</p>
                        </a>
                        <a href="#">
                            <p>Счетчики и приборы учета</p>
                        </a>
                    </div>
                    ...
                    <div class="col-3">
                        ...
                        <a href="#">
                            <p>Бесперебойное электроснабжение </p>
                        </a>
                        <a href="#">
                ...
                <div class="row justify-content-between">
                    <div class="col-8">
                        <div class="list-group list-group-horizontal list-group-light information">
                            <li class="list-group-item main-content but "><a class="but_url" href="#">Политика
                                    конфиденциальности</a></li>
                            <li class="list-group-item main-content but "><a class="but_url" href="#">Пользовательское
                                    соглашение</a></li>
                            <li class="list-group-item main-content but "><a class="but_url" href="#">Согласие на обработку
                                    персональных данных</a></li>
                            <li class="list-group-item main-content but "><a class="but_url" href="#">Публичная оферта</a>
                            </li>
                        </div>
                    </div>
                    <div class="col-auto">
                        <p class="about">© 2021 ООО "ОНЛАЙНСКЛАД"</p>
                    </div>
                </div>
            </div>
        </div>
